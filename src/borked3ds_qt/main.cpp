...
#endif
#include "borked3ds_qt/aboutdialog.h"
#include "borked3ds_qt/applets/mii_selector.h"
#include "borked3ds_qt/applets/swkbd.h"
#include "borked3ds_qt/bootmanager.h"
#include "borked3ds_qt/camera/qt_multimedia_camera.h"
#include "borked3ds_qt/camera/still_image_camera.h"
#include "borked3ds_qt/compatdb.h"
...
#include "borked3ds_qt/configuration/configure_per_game.h"
#include "borked3ds_qt/debugger/console.h"
#include "borked3ds_qt/debugger/graphics/graphics.h"
#include "borked3ds_qt/debugger/graphics/graphics_breakpoints.h"
#include "borked3ds_qt/debugger/graphics/graphics_cmdlists.h"
#include "borked3ds_qt/debugger/graphics/graphics_surface.h"
#include "borked3ds_qt/debugger/graphics/graphics_tracing.h"
#include "borked3ds_qt/debugger/graphics/graphics_vertex_shader.h"
#include "borked3ds_qt/debugger/ipc/recorder.h"
#include "borked3ds_qt/debugger/lle_service_modules.h"
#include "borked3ds_qt/debugger/registers.h"
#include "borked3ds_qt/debugger/wait_tree.h"
#include "borked3ds_qt/discord.h"
#include "borked3ds_qt/dumping/dumping_dialog.h"
#include "borked3ds_qt/game_list.h"
#include "borked3ds_qt/hotkeys.h"
#include "borked3ds_qt/infrared/skylanderportal/skylander_dialog.h"
#include "borked3ds_qt/loading_screen.h"
#include "borked3ds_qt/main.h"
#include "borked3ds_qt/movie/movie_play_dialog.h"
#include "borked3ds_qt/movie/movie_record_dialog.h"
#include "borked3ds_qt/multiplayer/state.h"
#include "borked3ds_qt/play_time_manager.h"
#include "borked3ds_qt/qt_image_interface.h"
#include "borked3ds_qt/uisettings.h"
#include "borked3ds_qt/updater/updater.h"
#include "borked3ds_qt/util/clickable_label.h"
#include "borked3ds_qt/util/graphics_device_info.h"
#include "borked3ds_qt/util/util.h"
...
GMainWindow::GMainWindow(Core::System& system_)
    ...
    if (gl_renderer.startsWith(QStringLiteral("D3D12"))) {
        ...
        // We can override the version here to allow Borked3DS to work.
...
#ifdef BORKED3DS_ENABLE_COMPATIBILITY_REPORTING
...
void GMainWindow::InitializeHotkeys() {
    ...
    link_action_shortcut(ui->action_Exit, QStringLiteral("Exit Borked3DS"));
...
void GMainWindow::ConnectMenuEvents() {
    ...
    // Help
    connect_menu(ui->action_Open_Borked3DS_Folder, &GMainWindow::OnOpenBorked3DSFolder);
    connect_menu(ui->action_Open_Log_Folder, []() {
        QString path = QString::fromStdString(FileUtil::GetUserPath(FileUtil::UserPath::LogDir));
        QDesktopServices::openUrl(QUrl::fromLocalFile(path));
    });
    connect_menu(ui->action_FAQ, []() {
        QDesktopServices::openUrl(QUrl(QStringLiteral("https://borked3ds-emu.org/wiki/faq/")));
    });
    connect_menu(ui->action_About, &GMainWindow::OnMenuAboutBorked3DS);
...
void GMainWindow::CheckForMigration() {
    ...
    if (fs::is_directory(FileUtil::GetUserPath(FileUtil::UserPath::LegacyUserDir)) &&
        ...
        if (QMessageBox::information(
                this, tr("Migration"),
                tr("Borked3DS has moved to a new data directory.\n\n"
...
void GMainWindow::MigrateUserData() {
    ...
    QMessageBox::information(
        this, tr("Migration"),
        tr("Data was migrated successfully. Borked3DS will now start.\n\n"
        ...
        case Core::System::ResultStatus::ErrorGetLoader:
            ...
            QMessageBox::critical(
                ...
                tr("Your ROM format is not supported.<br/>Please follow the guides to redump your "
                   ...
                   "cartridges</a> or "
                   "<a "
                   "href='https://web.archive.org/web/20240304210011/https://borked3ds-emu.org/"
                   "wiki/"
...
bool GMainWindow::MakeShortcutIcoPath(const u64 program_id, const std::string_view game_file_name,
    ...
    // Get path to Borked3DS icons directory & icon extension
    ...
    out_icon_path /=
        (program_id == 0 ? fmt::format("borked3ds-{}.{}", game_file_name, ico_extension)
                         : fmt::format("borked3ds-{:016X}.{}", program_id, ico_extension));
    return true;
}

void GMainWindow::OnGameListCreateShortcut(u64 program_id, const std::string& game_path,
                                           GameListShortcutTarget target) {
    std::string borked3ds_command{};
    bool skip_tryexec = false;
    const char* env_flatpak_id = getenv("FLATPAK_ID");
    if (env_flatpak_id) {
        borked3ds_command = fmt::format("flatpak run {}", env_flatpak_id);
        skip_tryexec = true;
    } else {
        // Get path to Borked3DS executable
        const QStringList args = QApplication::arguments();
        borked3ds_command = args[0].toStdString();
        // If relative path, make it an absolute path
        if (borked3ds_command.c_str()[0] == '.') {
            borked3ds_command =
                FileUtil::GetCurrentDir().value_or("") + DIR_SEP + borked3ds_command;
        }
    }
    ...
    if (borked3ds_command.ends_with(appimage_ending) &&
    ...
    const std::string comment = fmt::format("Start {:s} with the Borked3DS Emulator", game_title);
    const std::string categories = "Game;Emulator;Qt;";
    const std::string keywords = "3ds;Nintendo;";

    if (CreateShortcutLink(shortcut_path, comment, out_icon_path, borked3ds_command, arguments,
    ...
    case Service::AM::InstallStatus::ErrorEncrypted:
        QMessageBox::critical(this, tr("Encrypted File"),
                              tr("%1 must be decrypted "
                                 "before being used with Borked3DS. A real 3DS is required.")
                                  .arg(filename));
        break;
...
void GMainWindow::UninstallTitles(
    ...
    if (failed) {
        QMessageBox::critical(this, tr("Borked3DS"),
                              tr("Failed to uninstall '%1'.").arg(failed_name));
    } else if (!future_watcher.isCanceled()) {
        QMessageBox::information(this, tr("Borked3DS"),
...
void GMainWindow::OnMenuReportCompatibility() {
    if (!NetSettings::values.borked3ds_token.empty() &&
        !NetSettings::values.borked3ds_username.empty()) {
        CompatDB compatdb{this};
        compatdb.exec();
    } else {
        QMessageBox::critical(this, tr("Missing Borked3DS Account"),
                              tr("You must link your Borked3DS account to submit test cases."
...
void GMainWindow::OnOpenBorked3DSFolder() {
...
#ifdef _WIN32
           "\n\nTo install FFmpeg to Borked3DS, press Open and select your FFmpeg directory."
#endif
    ...
    if (result == QMessageBox::Help) {
        QDesktopServices::openUrl(
            QUrl(QStringLiteral("https://web.archive.org/web/20240301121456/https://"
                                "borked3ds-emu.org/wiki/installing-ffmpeg-for-the-video-dumper/")));
#ifdef _WIN32
    ...
    if (result == Core::System::ResultStatus::ErrorSystemFiles) {
        const QString common_message =
            tr("%1 is missing. Please <a "
               "href='https://borked3ds-emu.org/wiki/"
        ...
        message = tr(
            ...
            "<a href='https://community.borked3ds-emu.org/t/how-to-upload-the-log-file/296'>Check "
...
void GMainWindow::OnMenuAboutBorked3DS() {
...
bool GMainWindow::ConfirmClose() {
    ...
    QMessageBox::StandardButton answer =
        QMessageBox::question(this, tr("Borked3DS"), tr("Would you like to exit now?"),
...
static void PrintVersion() {
    std::cout << "\nBorked3DS " << Common::g_scm_branch << " " << Common::g_scm_desc << std::endl;
}
